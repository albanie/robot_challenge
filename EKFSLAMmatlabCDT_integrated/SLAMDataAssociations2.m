function [z] = SLAMDataAssociations2(x, z_raw,P)
  %%
  % SLAMDataAssociation
  %
  % INPUTS:
  ...
  for i=1:size(z_raw,1)
      ...
      iF = 3+2*nearest_neighbour_index-1;
      Cov = P(iF:iF+1, iF:iF+1)';
      
      C = chol(Cov);
      
      Mu = xFeaturesXY(nearest_neighbour_index);
